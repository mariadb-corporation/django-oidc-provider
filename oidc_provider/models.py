...
class ResponseType(models.Model):
    ...
    value = models.CharField(
        max_length=30, choices=RESPONSE_TYPE_CHOICES, unique=True, verbose_name=_(u"Response Type Value")
    )
...
class Client(models.Model):
    ...
    client_type = models.CharField(
        ...
        help_text=_(
            u"<b>Confidential</b> clients are capable of maintaining the confidentiality"
...
class Token(BaseCodeTokenModel):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, verbose_name=_(u"User"), on_delete=models.CASCADE)
    ...
    def has_expired_refresh_token(self):
        ...
        offset = oidc_settings.get("OIDC_REFRESH_TOKEN_EXPIRE") - oidc_settings.get("OIDC_TOKEN_EXPIRE")
